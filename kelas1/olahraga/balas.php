...
<p align="center"><?php //mengambil biodata yang membalas thread
		...
		$hasil=mysql_fetch_array(mysql_query("select * from tabel_topik_olahraga1 where id_topik='$id_topik'"));?>&nbsp;</p>
...
<table width="378" border="1" align="center">
  ...
  <tr>
    ...
    <td><strong>:
        <input name="id_topik" type="text" value="<?php echo $hasil['id_topik']; ?>" size="50" readonly="readonly" />
    </strong></td>
  </tr>
  <tr>
