...
$query6=mysql_fetch_array(mysql_query("select dilihat from tabel_topik_olahraga1 where id_topik='$id_topik'"));
...
$sql = "SELECT * FROM tabel_topik_olahraga1 ORDER by tanggal DESC";
