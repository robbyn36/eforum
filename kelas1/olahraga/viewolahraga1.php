...
if(isset($_SESSION['username'])){
	...
	$query2=mysql_fetch_array(mysql_query("select * from tabel_topik_olahraga1 where pengirim='$username'"));
...
<div id="tulisan">
<h2 align="center">Olahraga Kelas 1</h2>
<table width="719" border="0" align="center" style="border: 2px solid gray; border-radius: 10px 10px 10px 10px; background:#fff;">
  ...
  <tr>
	...
	$query5=mysql_fetch_array(mysql_query("select * from tabel_topik_olahraga1 where id_topik='$id_topik'"));
...
$nomor = 2;
$sql2="SELECT * FROM tabel_komentar_olahraga1 WHERE id_topik='$id_topik' ORDER BY tanggal desc";
        ...
        <tr>
          ...
          <th width="104" bgcolor="#FFFFFF" scope="col"><div align="center"><a href="../gantseniss.php"></a>
            <form id="form1" name="form1" method="post" action="">
              <a href="index2olahraga.php"><img src="../../images/indexpelajaran.png" width="89" height="64" alt="index" />Index seni1</a>
            </form>
          </div></th>
          <th width="108" bgcolor="#FFFFFF" scope="col"><form id="form3" name="form3" method="post" action="">
            <a href="../kelas1.php"><img src="../../images/indexkelas.png" width="79" height="63" alt="kelas" />Index Kelas 1</a>
          </form>
