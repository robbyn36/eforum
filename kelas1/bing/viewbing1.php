...
if(isset($_SESSION['username'])){
	...
	$query2=mysql_fetch_array(mysql_query("select * from tabel_topik_bing1 where pengirim='$username'"));
...
<div id="tulisan">
<h2 align="center">B.Inggris kelas 1</h2>
<table width="719" border="0" align="center" style="border: 2px solid gray; border-radius: 10px 10px 10px 10px; background:#fff;">
  ...
  <tr>
	...
	$query5=mysql_fetch_array(mysql_query("select * from tabel_topik_bing1 where id_topik='$id_topik'"));
...
$nomor = 2;
$sql2="SELECT * FROM tabel_komentar_bing1 WHERE id_topik='$id_topik' ORDER BY tanggal desc ";
    ...
    <td bgcolor="#FFFFFF"><div align="center">
      <table width="417" height="48" border="1" align="center">
        <tr>
          ...
          <th width="104" bgcolor="#FFFFFF" scope="col"><div align="center"><a href="../gantbingss.php"></a>
            <form id="form1" name="form1" method="post" action="">
              <a href="index2bing.php"><img src="../../images/indexpelajaran.png" width="82" height="59" alt="index" />Index B.Inggris 1</a>
            </form>
          </div></th>
