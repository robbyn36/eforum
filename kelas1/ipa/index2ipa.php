...
//Menghitung jumlah topik dan jumlah member
	$query3 = mysql_query("SELECT * FROM tabel_topik_ipa1");
...
$sql2 = "UPDATE tabel_topik_ipa1 SET dilihat='$dilihat' WHERE id_topik='$id_topik'";
...
<div id="tulisan">
<h2 align="center">IPA Kelas 1</h2>
...
$sql = "SELECT * FROM tabel_topik_ipa1 ORDER by tanggal DESC";
