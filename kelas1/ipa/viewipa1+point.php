...
<table width="719" border="0" align="center" style="border: 2px solid gray; border-radius: 10px 10px 10px 10px; background:#fff;">
  ...
  <tr>
	...
	$query5=mysql_fetch_array(mysql_query("select * from tabel_topik_ipa1 where id_topik='$id_topik'"));
...
$nomor = 2;
$sql2="SELECT * FROM tabel_komentar_ipa1 WHERE id_topik='$id_topik' ORDER BY tanggal DESC";
        ...
        <tr>
          ...
          <th width="104" bgcolor="#FFFFFF" scope="col"><div align="center"><a href="../gantipass.php"></a>
            <form id="form1" name="form1" method="post" action="">
              <a href="index2ipa.php"><img src="../../images/indexpelajaran.png" width="82" height="59" alt="index" />Index IPA 1</a>
            </form>
          </div></th>
