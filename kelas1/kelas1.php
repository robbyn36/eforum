...
<body bgcolor="#76c8f4" onload="MM_preloadImages('../images/imagekelas/ips2.PNG','../images/imagekelas/ipa2.PNG','../images/imagekelas/pkn2.PNG','../images/imagekelas/mtk2.PNG','../images/imagekelas/bindo2.PNG','../images/imagekelas/bing2.PNG','../images/imagekelas/seni2.PNG','../images/imagekelas/olahraga2.PNG')">
<div id="header">
...
<form id="form1" name="form1" method="post" action="">
  <div align="center">
    <table width="583" height="472" border="1">
      <tr>
        <th height="33" scope="col"><h2>Kelas 1</h2></th>
      </tr>
      <tr>
      ...
      <tr>
        <th bgcolor="#FFFFFF" scope="row"><table width="467" height="46" border="1" align="center">
          <tr>
            <th width="106" height="112" scope="col"><div align="center">
              <p><a href="../index/index.php"><img src="../images/home.png" alt="home" width="80" height="70" />Home</a></p>
            </div>
              <div align="center"></div></th>
            <th width="114" scope="col"><div align="center">
              <p><a href="../profil.php"><img src="../images/profil.png" alt="home" width="80" height="70" />Profil</a></p>
            </div></th>
            <th width="109" scope="col"><div align="center">
              <p><a href="../gantipass.php"><img src="../images/changepass.jpg" alt="home" width="80" height="70" />Ganti Password</a></p>
            </div></th>
            <th width="110" scope="col"><div align="center">
