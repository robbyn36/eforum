...
$sql = "INSERT INTO tabel_komentar_pkn1 (id_topik, topik, penjawab,  isi, tanggal) VALUES ('$id_topik', '$topik', '$penjawab', '$isi', '$tanggal')";
...
$query_balasan = mysql_query("SELECT id_topik_pkn1 FROM tabel_komentar_pkn1 WHERE id_topik='$id_topik'");
...
$sql2 = "UPDATE tabel_topik_pkn1 SET total_balasan='$total_balasan' WHERE id_topik='$id_topik'";
