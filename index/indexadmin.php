...
<form id="form1" name="form1" method="post" action="">
  <table width="900" height="502" border="0" align="center">
    <tr class="head1">
      <th colspan="2" rowspan="2" bgcolor="#FFFFFF" scope="col">Data User 
        <p><img src="<?php echo $avatar ?>" alt="" width="179" height="212" /></p>
        <p>Anda Login Sebagai :<?php echo $_SESSION['username']; echo " &nbsp;"?></p>
      <table width="247" border="1" align="center" margin-bottom="10">
        <tr>
          <th scope="col">Menu Admin</th>
          </tr>
        <tr>
          <th scope="col"><a href="../CRUD/adduservalidasi.php">Add User</a></th>
          </tr>
        <tr>
          <th scope="col"><a href="../hapuspost/hapuspost.php">Hapus Post</a></th>
        </tr>
        </table>
      <table width="248" border="1" align="center">
        <tr>
          <th colspan="3" scope="col">View Data User</th>
        </tr>
        <tr>
          <th width="62" scope="row"><a href="../CRUD/viewsiswa.php">Siswa</a></th>
          <th width="78"><a href="../crud/viewguru.php">Guru</a></th>
          <th width="86"><a href="../crud/view.php">Admin</a></th>
        </tr>
  </table>
      <p>&nbsp;</p></th>
      <th width="183" height="63" bgcolor="#FFFFFF" scope="col"><a href="../kelas1/kelas1.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('kelas 1','','../Menu/Kelas1_up.png',1)"><img src="../Menu/Kelas1.png" width="142" height="57" id="kelas 1" /></a></th>
    ...
    <tr>
      <td height="346" colspan="3" bgcolor="#FFFFFF"><img src="../images/forum.PNG" width="559" height="319" alt="fff" /></td>
    </tr>
    <tr>
      <th height="83" colspan="5" bgcolor="#FFFFFF" scope="row"><table width="351" height="79" border="1" align="right">
        <tr>
