...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <?php
$result = mysql_query("select * from tabel_member WHERE kelas='kelas2' order by id_member asc");
...
<td width="28%"><form id="form5" name="form5" method="post" action="">
  <a href="point2.php?e=<?php echo $data['id_member']?>"onclick="return confirm ('Tambah Point ?')">
