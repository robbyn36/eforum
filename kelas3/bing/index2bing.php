...
$query6=mysql_fetch_array(mysql_query("select dilihat from tabel_topik_bing3 where id_topik='$id_topik'"));
...
<div id="tulisan">
<h2 align="center">B.Inggris kelas 3</h2>
...
$sql = "SELECT * FROM tabel_topik_bing3 ORDER by tanggal DESC";
