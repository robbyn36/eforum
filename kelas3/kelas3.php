...
if (isset($_SESSION['kelas']))
{
   ...
   else if ($_SESSION['kelas2'] == "kelas2")
   {   
   	   header('location:batas.php');
   }
...
<form id="form1" name="form1" method="post" action="">
  <div align="center">
    <table width="569" height="424" border="1">
      ...
      <tr>
        <th scope="row"><table width="458" height="118" border="1" align="center">
          <tr>
            <th height="112" scope="col"><div align="center">
              <p><a href="../index/index.php"><img src="../images/home.png" alt="home" width="80" height="70" /><br />Home</a></p>
            </div>
              <div align="center"></div></th>
            <th scope="col"><div align="center">
              <p><a href="../profil.php"><img src="../images/profil.png" alt="home" width="80" height="70" /><br />
                Profil</a></p>
            </div></th>
            <th scope="col"><div align="center">
              <p><a href="../gantipass.php"><img src="../images/changepass.jpg" alt="home" width="84" height="83" /></a><a href="../gantipass.php"><br />
                Ganti Password</a></p>
            </div></th>
            <th scope="col"><div align="center">
              <p><a href="../logout.php"><img src="../images/log_off.png" alt="home" width="80" height="70" /><br />Keluar</a></p>
            </div></th>
          </tr>
        </table></th>
      </tr>
