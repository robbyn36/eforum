...
$query6=mysql_fetch_array(mysql_query("select dilihat from tabel_topik_mtk3 where id_topik='$id_topik'"));
...
$sql = "SELECT * FROM tabel_topik_mtk3 ORDER by tanggal DESC";
