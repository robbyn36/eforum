...
<form id="form1" name="form1" method="post" action="proses_create.php">
  <table width="608" height="319" border="1" align="center">
    <tr>
      <td colspan="3" bgcolor="#ffffff"><div align="center"><strong><font face="verdana" size="5">Post Baru</font></strong></div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="332" valign="top"><strong>
        <input name="topik" type="text" size="40" maxlength="40" />
