...
if(isset($_SESSION['username'])){
	...
	$query2=mysql_fetch_array(mysql_query("select * from tabel_topik_ips3 where pengirim='$username'"));

//Menghitung jumlah topik dan jumlah member
	$query3 = mysql_query("SELECT * FROM tabel_topik_ips3");
...
$query6=mysql_fetch_array(mysql_query("select dilihat from tabel_topik_ips3 where id_topik='$id_topik'"));
$dilihat = $query6 ['dilihat'] + 1;
$sql2 = "UPDATE tabel_topik_ips3 SET dilihat='$dilihat' WHERE id_topik='$id_topik'";
...
<div id="tulisan">
<h2 align="center">IPS kelas 3</h2>
...
$sql = "SELECT * FROM tabel_topik_ips3 ORDER by tanggal DESC";
          ...
          <tr>
            ...
            <td valign="top"><img src="../../images/thread.png" alt="" width="27" height="25" align="left" />
              <form id="form1" name="form1" method="post" action="">
                &nbsp;
                <font face="verdana" size="2"><a href="viewips1.php?id_topik=<?php echo $record['id_topik']; ?>"><?php echo $record['topik']; ?></a></font>
              </form></td>
