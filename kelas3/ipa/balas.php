...
<p align="center"><?php //mengambil biodata yang membalas thread
		...
		$hasil=mysql_fetch_array(mysql_query("select * from tabel_topik_ipa3 where id_topik='$id_topik'"));?>&nbsp;</p>
...
<table width="378" border="1" align="center">
  ...
  <tr>
    ...
    <td><strong>:
        <input name="id_topik" type="text" size="50" value="<?php echo $hasil['id_topik']; ?>" readonly="readonly" />
    </strong></td>
  </tr>
  <tr>
    <td><strong>Topik</strong></td>
    <td><strong>:
        <input name="topik" type="text" id="topik" value="<?php echo $hasil['topik']; ?>" size="50" readonly="readonly" />
    </strong></td>
  </tr>
  <tr>
    <td><strong>Penjawab</strong></td>
    <td><strong>:
        <input name="penjawab" type="text" value="<?php echo $username; ?>" size="50" readonly="readonly" />
    </strong></td>
  </tr>
  <tr>
