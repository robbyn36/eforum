...
$query6=mysql_fetch_array(mysql_query("select dilihat from tabel_topik_mtk2 where id_topik='$id_topik'"));
...
$sql = "SELECT * FROM tabel_topik_mtk2 ORDER by tanggal DESC";
          ...
          <tr>
            ...
            <td valign="top"><img src="../../images/thread.png" alt="" width="27" height="25" align="left" />
              <form id="form1" name="form1" method="post" action="">
                &nbsp;
                <font face="verdana" size="2"><a href="viewmtk1.php?id_topik=<?php echo $record['id_topik']; ?>"><?php echo $record['topik']; ?></a></font>
              </form></td>
