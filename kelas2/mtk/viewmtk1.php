...
if(isset($_SESSION['username'])){
	...
	$query2=mysql_fetch_array(mysql_query("select * from tabel_topik_mtk2 where pengirim='$username'"));
...
<div id="tulisan">
<h2 align="center">Matematika kelas 2</h2>
<table width="719" border="0" align="center" style="border: 2px solid gray; border-radius: 10px 10px 10px 10px; background:#fff;">
  ...
  <tr>
	...
	$query5=mysql_fetch_array(mysql_query("select * from tabel_topik_mtk2 where id_topik='$id_topik'"));
...
$nomor = 2;
$sql2="SELECT * FROM tabel_komentar_mtk2 WHERE id_topik='$id_topik' ORDER BY tanggal desc";
        ...
        <tr>
          ...
          <th width="104" bgcolor="#FFFFFF" scope="col"><div align="center"><a href="../gantmtkss.php"></a>
            <form id="form1" name="form1" method="post" action="">
              <a href="index2mtk.php"><img src="../../images/indexpelajaran.png" width="89" height="64" alt="index" />Index mtk 2</a>
            </form>
          </div></th>
