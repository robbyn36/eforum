...
if(isset($_SESSION['username'])){
	...
	$query2=mysql_fetch_array(mysql_query("select * from tabel_topik_bing2 where pengirim='$username'"));
...
<table width="719" border="0" align="center" style="border: 2px solid gray; border-radius: 10px 10px 10px 10px; background:#fff;">
  ...
  <tr>
	...
	$query5=mysql_fetch_array(mysql_query("select * from tabel_topik_bing2 where id_topik='$id_topik'"));
...
$nomor = 2;
$sql2="SELECT * FROM tabel_komentar_bing2 WHERE id_topik='$id_topik' ORDER BY tanggal desc ";
        ...
        <tr>
          ...
          <th width="104" bgcolor="#FFFFFF" scope="col"><div align="center"><a href="../gantbingss.php"></a>
            <form id="form1" name="form1" method="post" action="">
              <a href="index1bing.php"><img src="../../images/indexpelajaran.png" width="82" height="59" alt="index" />Index bing2</a>
            </form>
          </div></th>
          <th width="108" bgcolor="#FFFFFF" scope="col"><form id="form3" name="form3" method="post" action="">
            <a href="../kelas2.php"><img src="../../images/indexkelas.png" width="79" height="63" alt="kelas" />Index Kelas 1</a>
          </form>
