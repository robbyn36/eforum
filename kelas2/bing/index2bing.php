...
$query6=mysql_fetch_array(mysql_query("select dilihat from tabel_topik_bing2 where id_topik='$id_topik'"));
...
<div id="tulisan">
<h2 align="center">B.Inggris kelas 2</h2>
...
$sql = "SELECT * FROM tabel_topik_bing2 ORDER by tanggal DESC";
