...
<table width="719" border="0" align="center" style="border: 2px solid gray; border-radius: 10px 10px 10px 10px; background:#fff;">
  ...
  <tr>
	...
	$query5=mysql_fetch_array(mysql_query("select * from tabel_topik_ipa2 where id_topik='$id_topik'"));
...
$nomor = 2;
$sql2="SELECT * FROM tabel_komentar_ipa2 WHERE id_topik='$id_topik' ORDER BY tanggal DESC";
    ...
    <td bgcolor="#FFFFFF"><div align="center">
      <table width="417" height="48" border="1" align="center">
        <tr>
          ...
          <th width="104" bgcolor="#FFFFFF" scope="col"><div align="center"><a href="../gantipass.php"></a>
            <form id="form1" name="form1" method="post" action="">
              <a href="index2ipa.php"><img src="../../images/indexpelajaran.png" width="82" height="59" alt="index" />Index ipa2</a>
            </form>
          </div></th>
