...
$query6=mysql_fetch_array(mysql_query("select dilihat from tabel_topik_bindo2 where id_topik='$id_topik'"));
...
$sql = "SELECT * FROM tabel_topik_bindo2 ORDER by tanggal DESC";
