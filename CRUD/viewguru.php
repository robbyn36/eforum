...
<?php
$result = mysql_query("select * from tabel_member where tipe='guru' order by id_member desc");
...
<td><a href="update.php?u=<?php echo $data['id_member']?>"></a> <form name="form9" method="post" action="">
  <div align="center"><a href="updateguru.php?u=<?php echo $data['id_member']?>">edit</a>
  / <a href="deleteguru.php?d=<?php echo $data['id_member']?>"onclick="return confirm('Are you sure you want to delete?')">hapus</a><br/>
