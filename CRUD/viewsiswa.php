...
<th width="7%" bgcolor="#999999">Kelas</th>
<th width="16%" bgcolor="#999999">Action</th>
</tr>
<?php
$result = mysql_query("select * from tabel_member where tipe='murid' order by id_member desc");
while($data=mysql_fetch_array($result)){?>
<tr>
<td height="40"><?php echo $data['id_member']?></td>
...
<td><a href="update.php?u=<?php echo $data['id_member']?>"></a> <form name="form9" method="post" action="">
  <div align="center"><a href="updatesiswa.php?u=<?php echo $data['id_member']?>">edit</a>
  / <a href="deletesiswa.php?d=<?php echo $data['id_member']?>"onclick="return confirm('Are you sure you want to delete?')">hapus</a><br/>
...
<table width="176" height="46" border="1" align="center">
  <tr>
    ...
    <th bgcolor="#FFFFFF" width="80" scope="col"><form name="form10" method="post" action="">
      <a href="../logout.php"><img src="../images/log_off.png" alt="home" width="78" height="74" />Keluar</a>
    </form></th>
  </tr>
</table>
</body>
