...
<form id="form1" name="form1" method="post" action="proses_registrasi.php">
  <table width="552" border="1" align="center">
    ...
    <tr>
      <td align="left" valign="top"><span class="hitam">Re-Password</span></td>
      <td align="left" valign="top"><span class="hitam">
    ...
    <tr>
      ...
      <td align="left" valign="top"><label for="select6"></label>
        <select name="avatar" id="select6">
          <option>http://localhost/forum/S2V2/avatar/admin.png</option>
          <option>http://localhost/forum/S2V2/avatar/guru.png</option>
          <option>http://localhost/forum/S2V2/avatar/siswa.png</option>
        </select> </td>
    </tr>
    <tr>
